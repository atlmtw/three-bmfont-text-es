...
import { BufferGeometry, BufferAttribute, Sphere, Box3 } from 'three'; // const THREE = require('three');
...
class TextGeometry extends BufferGeometry {
  constructor(opt) {
    ...
    this._opt = Object.assign({}, opt); // also do an initial setup...
  ...
  update(opt) {
    ...
    this.setAttribute('uv', new BufferAttribute(uvs, 2)); // update multipage data
